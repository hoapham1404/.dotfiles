...
--
-- Check if alacritty is installed and use it as default terminal, otherwise use x-terminal-emulator
local terminal
if os.execute("which wezterm") then
	terminal = "wezterm"
else
	terminal = "x-terminal-emulator"
end
...
globalkeys = gears.table.join(
	awful.key({ modkey, "Shift" }, "p", hotkeys_popup.show_help, { description = "show help", group = "awesome" }),
